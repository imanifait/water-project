...
class WaterController extends Controller
{
    ...
    function customerPost(Request $request){
        $request->validate([
            'name'=>'required',
            'email'=>'required|unique:customerdetails',
            'mobile_number'=>'required|unique:customerdetails',
            ]);
            ...
            if(!$user){
                return redirect(route('customer'))->with("error","Registration Failed ,Try again");
            }
                return redirect(route('customer'))->with("success","Registration successful");
        }
